...
bool Inferno::IsValid(_In_ const WAVEFORMATEX* wfx) noexcept
{
    if (!wfx)
        return false;
...
uint32_t Inferno::GetDefaultChannelMask(int channels) noexcept
{
    switch (channels)
    {
...
_Use_decl_annotations_
bool Inferno::ComputePan(float pan, unsigned int channels, float* matrix) noexcept
{
