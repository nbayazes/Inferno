...
namespace Inferno {
    ...
    bool IntersectRaySegments(Level& level, const Ray& ray, span<SegID> segments, float maxDist, bool passTransparent, bool hitTestTextures, LevelHit* hitResult = nullptr, float offset = 0);
