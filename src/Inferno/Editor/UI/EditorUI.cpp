        ...
        if (ImGui::BeginMainMenuBar()) {
                ...
                if (!Settings::Editor.RecentFiles.empty()) {
                    ...
                    for (auto& file : Settings::Editor.RecentFiles) {
                        ...
                        if (ImGui::MenuItem(file.filename().string().c_str()))
                            if (CanCloseCurrentFile()) Game::EditorLoadLevel(file);
                    }
                }
            ...
            if (ImGui::BeginMenu("Edit")) {
                if (ImGui::BeginMenu("Go To")) {
                    ...
                    MenuCommandEx(Commands::GotoRoom, "Go To Room...", EditorAction::ShowGotoRoom);
            ...
            if (ImGui::BeginMenu("View")) {
                ...
                ImGui::MenuItem("Escape Path", nullptr, &Settings::Editor.ShowEscapePath);
