...
namespace Inferno::Colors {
    ...
    constexpr Color Unexplored = { 1.0f, 1.0f, 1.0f, 0.75f };
    ...
    constexpr Color Robot = Inferno::ColorFromRGB(255, 0, 255);
    constexpr Color Player = Inferno::ColorFromRGB(137, 160, 210);
    constexpr Color Powerup = Inferno::ColorFromRGB(255, 177, 106);
    ...
    constexpr std::pair<Color, Color> ForSegment(Inferno::SegmentType type) {
        using Inferno::SegmentType;
