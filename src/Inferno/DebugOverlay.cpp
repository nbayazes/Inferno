...
namespace Inferno {
    ...
    void DrawGameDebugOverlay(const ImVec2& pos, const ImVec2& pivot) {
        ImGui::SetNextWindowPos(pos, ImGuiCond_Always, pivot);
        ...
        if (ImGui::Begin("Game Debug Overlay", nullptr, flags)) {
            ...
            ImGui::Text("Segments: %d", Game::Debug::VisibleSegments);
            ...
            ImGui::Text("Fog passes: %d", Render::Stats::FogPasses);
